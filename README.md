...
│                         tenant-advocate-rag and configuration for tools like black
│
...
│
└── tenant-advocate-rag   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes tenant-advocate-rag a Python module
    │
